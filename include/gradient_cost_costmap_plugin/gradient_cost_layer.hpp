...
#include <gradient_cost_plugin/GradientCostPluginConfig.h>
...
namespace gradient_cost_plugin
{
   ...
   */
  class GradientCostLayer : public costmap_2d::CostmapLayer
  {
  public:
    /*!
     * \brief Constructor
     ...
     * \param level
     */
    void reconfigureCB(gradient_cost_plugin::GradientCostPluginConfig &config, uint32_t level);

    /*!
     * \brief  A callback to handle buffering PointCloud2 messages
     * \param cloud The cloud (message) returned from a message notifier
     */
    void pointCloud2Callback(sensor_msgs::PointCloud2::ConstPtr cloud);
  ...
  protected:
    ...
    /// \brief Dynamic parameters server
    std::unique_ptr<dynamic_reconfigure::Server<gradient_cost_plugin::GradientCostPluginConfig>> dy_param_server_;
     ...
     */
    sensor_msgs::PointCloud2 cloud_transf_;

    /*!
     * \brief Origin of the sensor, transformed to global frame.
     */
    geometry_msgs::PointStamped orig_transf_point_;
     ...
     */
    sensor_msgs::PointCloud2 global_frame_cloud_;
